...
export class Broker extends TypedEmitter<BrokerEvents> {
    ...
    accept(stream: Socket) {
        ...
        // The LG modem goes quiet for long stretches when the appliance is
        // powered off; a short idle timeout kicks it out and the firmware then
        // needs a slow certificate dance to reconnect. Keep the dead-socket
        // safety net, but make it generous.
